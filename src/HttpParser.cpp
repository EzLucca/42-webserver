...
void HttpParser::parseRequestLine(std::string& line, HttpRequest& request)
{
    ...
    if (firstSpace != std::string::npos && secondSpace != std::string::npos)
    {
		...
		if (uri.find("../") != std::string::npos || uri.find("/..")  != std::string::npos
			...
			|| uri.find("%2e%2e") != std::string::npos || uri.find("%2E%2E") != std::string::npos
			|| uri.find("%2f") != std::string::npos || uri.find("%2F") != std::string::npos
			|| uri.find("%5c") != std::string::npos || uri.find("%5C") != std::string::npos)
